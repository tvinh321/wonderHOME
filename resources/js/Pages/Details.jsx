                    ...
                    <div className="lg:px-32 lg:pb-14 lg:my-0 lg:pt-14 w-full py-8 px-8">
                        ...
                        <div className="grid-cols-4 space-y-4 md:space-y-0 md:grid md:gap-2 md:grid-rows-2">
                            <div className="w-full col-span-2 row-span-2">
                                <img
                                    className="rounded-xl md:h-full md:object-cover"
                                    src="/assets/images/Room5.jpg"
                                    alt="Room 1"
                                />
                            </div>

                            {house.files?.images?.map((image, index) => {
                                return index < 3 ? (
                        ...
                        <div className="w-full rounded pt-2">
                            <div className="mt-4 flex justify-items-end">
                                <span className="text-sm flex py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline border-b border-t border-l border-neutral-900 rounded-l-lg justify-center items-center">
                                    ...
                                    <span>
                                        {(house.price / 1000000000).toFixed(1)}{" "}
                                        tỷ
                                    </span>
                                </span>
                                ...
                                <span className="text-sm flex py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline border-b border-t border-r border-neutral-900 rounded-r-lg justify-center items-center">
                                    ...
                                    <span>
                                        {house.num_of_bedrooms} phòng ngủ
                                    </span>
                                </span>
                            </div>
                        </div>
                                ...
                                <div className="mb-10 lg:mb-24">
                                    ...
                                    <div className="mx-auto md:mt-6 mt-4">
                                        {/* <p className="leading-loose whitespace-pre-wrap text-justify">
                                            Chủ đầu tư Hibrand Việt Nam (Phòng
                                            bán hàng dự án, tại tầng 1 - Tòa A
                                            chung cư Cosmos City - ngã ba phố
                                            Văn Khê và phố Phúc La, có hình ảnh
                                            kèm theo) bán những căn hộ còn lại
                                            của chung cư cao cấp Cosmos City,
                                            Văn Phú, Hà Đông, Hà Nội tại vị trí
                                            trung tâm, đắc địa còn lại duy nhất
                                            của quận Hà Đông, nằm trên 250m mặt
                                            tiền phố Văn Khê và phố Phú La, mặt
                                            sau hướng vườn hoa nội khu rộng
                                            10.000m², là phần đẹp nhất của khu
                                            đô thị Văn Phú rộng 94,3ha. Cosmos
                                            City cách BRT chỉ 50m, cách UBND
                                            quận 500m, cách trường chuyên Nguyễn
                                            Huệ, Ban Mai, Tiểu học, THCS Phú La
                                            300 m, trường Marie Curie cơ sở Hà
                                            Đông 200m; giáp trụ sở UBND và Công
                                            an phường Phú La... Đặc biệt, do chỉ
                                            cách ga La Khê đường tàu điện trên
                                            cao Cát Linh - Hà Đông có 200m nên
                                            từ dự án chỉ mất 23 phút đã có mặt
                                            tại Cát Linh; 15 phút có mặt tại Ngã
                                            tư Sở... Cosmos City được xây dựng
                                            theo công nghệ hiện đại nhất của Hàn
                                            Quốc (đúc bê tông cả tòa nhà, các
                                            phòng không có cột nên các phòng đều
                                            vuông); Chủ đầu tư đang bàn giao nhà
                                            cho khách hàng bắt đầu từ ngày 15/7
                                            năm 2022. Hiện tại các cư dân đã bắt
                                            đầu vào ở. Các căn hộ có 1 PN, 2 PN
                                            và 3PN với diện tích thông thủy từ
                                            47,32m² - 68,44m² - 77,91m² -
                                            84,01m² - 85,55m² - 87,79m² -
                                            100,89m² - 111,76m² - 117,36m². Căn
                                            hộ bàn giao nội thất cao cấp, đầy đủ
                                            bao gồm: Sàn gỗ và hệ thống cửa
                                            thông phòng nhập khẩu; khóa từ thông
                                            minh; điều hòa âm trần; thiết bị vệ
                                            sinh ToTo; tủ bếp và thiết bị bếp
                                            nhập khẩu; tủ quần áo, tủ giày liền
                                            tường; hệ thống ánh sáng được bố trí
                                            khoa học với các thiết bị cao cấp...
                                            Tiến độ thanh toán và chính sách bán
                                            hàng linh hoạt, bảo đảm quyền lợi
                                            cho khách hàng, cụ thể như sau: 1.
                                            Đối với khách hành vay ngân hàng:
                                            Tiến độ thanh toán chia làm 4 đợt:
                                            Đợt 1: 25% GTCH (và ký HĐMB). Đợt 2:
                                            25% GTCH (trong vòng 30 ngày kể từ
                                            ngày ký HĐMB). Đợt 3: 45% GTCH khi
                                            nhận bàn giao căn hộ. Đợt 4: 5% GTCH
                                            khi cấp sổ hồng cho căn hộ. Riêng
                                            đối với các căn hộ thuộc Toà A: Chủ
                                            đầu tư hỗ trợ lãi suất cho vay 0%
                                            trong vòng 12 tháng kể từ ngày ký
                                            HĐMB; giải ngân song song ngay từ
                                            đợt đầu tiên theo tỷ lệ khách hàng
                                            nộp 30%, ngân hàng cho vay tối đa
                                            70% số tiền cần nộp của mỗi đợt;
                                            thời gian cho vay tối đa 30 năm và
                                            tài sản thế chấp bằng chính căn hộ
                                            Cosmos City. 2. Đối với khách hàng
                                            không vay ngân hàng hoặc tự vay ngân
                                            hàng thương mại: Đợt 1: 20% GTCH (và
                                            ký HĐMB). Đợt 2: 10% GTCH (trong
                                            vòng 30 ngày kể từ ngày ký HĐMB).
                                            Đợt 3: 20% GTCH (trong vòng 60 ngày
                                            kể từ ngày ký HĐMB). Đợt 4: 45% GTCH
                                            khi bàn giao căn hộ. Đợt 5: 5% GTCH
                                            khi cấp sổ hồng cho căn hộ. * Thông
                                            tin chi tiết cụ thể, khách hàng đến
                                            Phòng bán hàng của Chủ đầu tư
                                            Hibrand Việt Nam tại tầng 1, Tòa A
                                            chung cư Cosmos City (ngã ba phố Văn
                                            Khê và phố Phúc La) để được tư vấn
                                            mua những căn hộ cuối cùng của dự án
                                            và tham quan trực tiếp căn nhà cần
                                            mua mới cảm nhận được sự khác biệt
                                            của dự án với phân khúc cùng khu
                                            vực..
                                        </p> */}
                                        <p className="leading-loose whitespace-pre-wrap text-justify">
                                            {house.description}
