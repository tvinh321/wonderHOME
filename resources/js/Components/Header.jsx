        ...
        <header>
            <nav>
                ...
                <div class="relative flex h-16 items-center justify-center">
                    ...
                    <div class="hidden md:ml-6 md:block">
                        <div class="flex space-x-4">
                        {
                            NAVLINK_VIE.map((value, index) => {
                                return <a href={SERVICES[index]} class="text-neutral-900 hover:bg-neutral-900 hover:text-white block px-3 py-2 rounded-md text-base font-medium transition-all duration-150">{value}</a>
                            })
                        }
                        </div>
                    </div>
                    ...
                    <button class="hidden md:flex group mr-4 text-amber-300 border border-amber-300 hover:border-transparent hover:bg-amber-300 font-bold py-2 px-4 rounded items-center">
                        ...
                        isLoggedIn ? (
                            ...
                            <a href="/dang-nhap">
                                <button class="group mr-4 bg-amber-300 text-neutral-900 hover:bg-amber-300 font-bold py-2 px-4 rounded inline-flex items-center">
                                    ...
                                    <svg class="fill-neutral-900 group-hover:fill-white transition-all duration-150" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                                        <g>
                ...
                <div class="space-y-1 px-2 pt-2 pb-3">
                    {
                        NAVLINK_VIE.map((item, index) => (
                            <a href={SERVICES[index]} class="text-neutral-900 hover:bg-neutral-900 hover:text-white block px-3 py-2 rounded-md text-base font-medium">{item}</a>
                        ))
                    }
                </div>
                </div>
